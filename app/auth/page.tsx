...
export default function AuthPage() {
  ...
  const getOauthErrorMessage = (code: string | null) => {
    ...
    const mapping: Record<string, string> = {
      google_config_missing: "Google sign-in is not configured yet (missing GOOGLE_CLIENT_ID / GOOGLE_CLIENT_SECRET).",
  ...
  const onSocialClick = (provider: "google" | "facebook") => {
    ...
    window.location.href = provider === "google" ? "/api/oauth/google/start" : "/api/oauth/facebook/start";
  };
  ...
  return (
    <section className="auth-wrap">
      <div className="auth-card">
        ...
        {mode === "signin" && oauthError ? <p className="form-error">{getOauthErrorMessage(oauthError)}</p> : null}
